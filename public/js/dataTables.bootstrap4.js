...
(function(a) {
    ...
    a.extend(d.ext.classes, { sWrapper: "dataTables_wrapper dt-bootstrap4", sFilterInput: "form-control form-control-sm rounded-0", sLengthSelect: "custom-select custom-select-sm form-control form-control-sm rounded-0", sProcessing: "dataTables_processing card", sPageButton: "paginate_button page-item" });
